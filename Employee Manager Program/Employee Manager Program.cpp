...
void Menu()
{
    ...
    printf(ANSI_COLOR_BLUE "\t\t\t\t\t\t\tMain Menu" ANSI_COLOR_RESET "\n");
    printf(ANSI_COLOR_GREEN "\t1.Create an Employee Profile\t" ANSI_COLOR_RESET);
    printf(ANSI_COLOR_CYAN "\t2.Delete an Employee Profile\t" ANSI_COLOR_RESET);
    printf(ANSI_COLOR_YELLOW "\t3.Show Employee Profile\t" ANSI_COLOR_RESET);
    scanf("%d", &Pickups);
    getchar(); //Making Sure Thit is Not Skiping (C/C++ Bug)
    switch (Pickups)
    {
